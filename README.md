...
AI-платформа для профессионального роста.
Что делает:

Анализирует твои навыки и находит пробелы относительно цели
Генерирует персональную карту заданий с пошаговыми инструкциями
Адаптирует сложность под твой уровень (junior → middle → senior)
Готовит к собеседованиям с AI-ревью ответов
Автоматически собирает документы: резюме, отчёты о проектах, кейсы для портфолио

Стек: Vite · Vanilla JS · Supabase · OpenRouter · Vercel
Демо: careerpath-ecru.vercel.app
